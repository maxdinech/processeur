...
# 232 "/usr/share/menhir/standard.mly"
    ( xs )
...
# 213 "/usr/share/menhir/standard.mly"
    ( x :: xs )
...
# 243 "/usr/share/menhir/standard.mly"
    ( x :: xs )
# 507 "netlist_parser.ml"
         in
...
and _menhir_reduce18 : _menhir_env -> 'ttv_tail -> _menhir_state -> 'ttv_return =
  fun _menhir_env _menhir_stack _menhir_s ->
    let _v : (Netlist_ast.equation list) = 
# 211 "/usr/share/menhir/standard.mly"
    ( [] )
...
# 802 "netlist_parser.ml"
    ...
    | IN ->
        ...
        let (_menhir_stack, _menhir_s, (x : (Netlist_ast.Env.key * Netlist_ast.ty))) = _menhir_stack in
        let _v : ((Netlist_ast.Env.key * Netlist_ast.ty) list) = 
# 241 "/usr/share/menhir/standard.mly"
    ( [ x ] )
# 826 "netlist_parser.ml"
         in
        _menhir_goto_separated_nonempty_list_COMMA_var_ _menhir_env _menhir_stack _menhir_s _v
    | _ ->
        assert (not _menhir_env._menhir_error);
...
# 26 "netlist_parser.mly"
       (string)
# 847 "netlist_parser.ml"
    )) = _v in
    let _v : (int) = 
# 76 "netlist_parser.mly"
            ( int_of_string c )
# 852 "netlist_parser.ml"
     in
    let _menhir_stack = (_menhir_stack, _menhir_s, _v) in
    match _menhir_s with
    | MenhirState11 ->
    ...
    | MenhirState7 ->
        ...
        | VAR ->
            ...
            | IN ->
                ...
                let _v : ((Netlist_ast.Env.key * Netlist_ast.ty) list) = 
# 142 "/usr/share/menhir/standard.mly"
    ( [] )
...
# 27 "netlist_parser.mly"
       (string)
# 1095 "netlist_parser.ml"
        ))) = _menhir_stack in
        let _2 = () in
        let _v : (Netlist_ast.ident list) = 
# 243 "/usr/share/menhir/standard.mly"
    ( x :: xs )
# 1101 "netlist_parser.ml"
         in
...
# 27 "netlist_parser.mly"
       (string)
# 1302 "netlist_parser.ml"
        ))) = _menhir_stack in
        let _v : (Netlist_ast.ident list) = 
# 241 "/usr/share/menhir/standard.mly"
    ( [ x ] )
# 1307 "netlist_parser.ml"
         in
        _menhir_goto_separated_nonempty_list_COMMA_NAME_ _menhir_env _menhir_stack _menhir_s _v
    | _ ->
        assert (not _menhir_env._menhir_error);
